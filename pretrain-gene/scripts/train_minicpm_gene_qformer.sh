...
OUTPUT_PATH="/data2/xiaoxinyu/project/pretrain-gene/sft_output/brain-gene_$(date +%m%d_%H%M)"
LOG_PATH="/data2/xiaoxinyu/project/pretrain-gene/logs/brain-gene_sft_$(date +%m%d_%H%M).log"
